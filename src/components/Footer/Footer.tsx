    ...
    >
      ...
      >
          ...
          <Flex ml={2} isTruncated>
            {currentlyPlaying?.songUrl ? (
              ...
              >
                ...
                {error ? `There was an error` : `Lonely...`}
              </chakra.p>
            )}
            <chakra.span
              mx={2}
        ...
        <Stack
          ...
          mr={{ base: `auto`, md: 5 }}
        >
          <SocialIcons label="GitHub" href="https://github.com/bhavesh149/">
            <FaGithub />
          </SocialIcons>
          <SocialIcons
            label="LinkedIn"
            href="https://www.linkedin.com/in/bhavesh-mahajan-b4255922b/"
          >
            <FaLinkedin />
          </SocialIcons>

          <SocialIcons label="Email" href="mailto:mahajanbhaveshop2@gmail.com">
            <HiOutlineMail />
          </SocialIcons>
        </Stack>
      </SimpleGrid>
